        ...
        activity.setEnterSharedElementCallback(new SharedElementCallback() {
            ...
            public View onCreateSnapshotView(Context context, Parcelable snapshot) {
                if (snapshot instanceof ShareElementInfo) {
                    ...
                    Log.e("onSharedElementView","onCreateSnapshotView : "+(view));
                    return view;
                } else {
                    return super.onCreateSnapshotView(context, snapshot);
                }
            ...
            public void onSharedElementStart(List<String> sharedElementNames, List<View> sharedElements, List<View> sharedElementSnapshots) {
                ...
                if (sharedElements != null && sharedElementSnapshots != null) {
                    for (int i = 0; i < sharedElements.size(); i++) {
                        ...
                        Log.e("onSharedElementStart","sharedElementSnapshots.get(i): "+(sharedElementSnapshots.get(i)));
                        Log.e("onSharedElementStart","sharedElementNames.get(i): "+(sharedElementNames.get(i)));
                ...
                for (int i = 0; sharedElements != null && i < sharedElements.size(); i++) {
                    ...
                    if (shareElementInfo != null) {
...

                        {
                            ...
                            Log.e("onSharedElementEnd","snapshotView == null: "+(snapshotView == null));
                            Log.e("onSharedElementEnd","sharedElementSnapshots.get(i): "+(sharedElementSnapshots.get(i)));
                            Log.e("onSharedElementEnd","sharedElementNames.get(i): "+(sharedElementNames.get(i)));
